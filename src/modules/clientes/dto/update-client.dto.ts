import { IsEmail, IsNotEmpty, IsNumber, IsNumberString, IsOptional, IsPhoneNumber, IsString, Matches, MaxLength, MinLength, Validate } from "class-validator";
...
export class UpdateClientDto {
    ...
    @IsNumber()
    @IsNotEmpty({
        message: 'El ID de identificación es requerida',
    })
    readonly id_identificacion: number;
